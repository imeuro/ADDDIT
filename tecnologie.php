		...
		<section id="ddd-about-tecnologie" class="block-section block-section-slanted block-section-white">
			<div class="technologies text">
				...
				<ul class="tech-list">
					...
					<li id="BinderJetting"><strong>Binder Jetting:</strong> Una tecnologia di stampa 3D che utilizza una serie di jet di resina per costruire un oggetto strato per strato. Questo processo permette di creare oggetti con una grande varietà di materiali e colori.</li>
				    ...
				    <li id="Polyjet"><strong>DMLM (Direct Metal Laser Melting):</strong> Una tecnologia di stampa 3D metallica che utilizza un fascio di elettroni per fondere le polveri metalliche. Mentre la DMLS fonde solo la superficie del materiale, la DMLM fonde completamente il materiale, creando un solido metallico denso e uniforme.</li>
				    <li id="SLM"><strong>SLM (Selective Laser Melting):</strong> Una tecnologia di stampa 3D metallica che utilizza un fascio laser per fondere e formare un materiale metallico. Questo processo permette di creare oggetti con una grande varietà di materiali e colori.</li>
				    <li id="LFFDM"><strong>Large Format FDM:</strong> si riferisce a stampanti 3D FDM progettate per produrre oggetti di dimensioni significativamente maggiori rispetto alle stampanti FDM standard..</li>
				    <li id="MJP"><strong>MJP (Multi Jet Printing):</strong> Una tecnologia di stampa 3D che utilizza una serie di jet di resina per costruire un oggetto strato per strato. Questo processo permette di creare oggetti con una grande varietà di materiali e colori.</li>
				</ul>
